...
import me.nkeor.device.DeviceSettings.R;
...
public class FPSTileService extends TileService {
  ...
  public void onStartListening() {
      ...
      for (ActivityManager.RunningServiceInfo service :
          ...
          if (me.nkeor.device.DeviceSettings.FPSInfoService.class.getName().equals(
  ...
  @Override
  public void onClick() {
      Intent fpsinfo = new Intent(this, me.nkeor.device.DeviceSettings.FPSInfoService.class);
      if (!isShowing)
